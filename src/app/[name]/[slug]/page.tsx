...
export default function PreviewPage() {
  ...
  return (
    <main className="min-h-screen flex flex-col" style={themeStyles}>
      {sortedSections
        .filter((s) => s.visible)
        .map((section) => (
      ...
      {/* Attribution footer */}
      <footer className="py-6 text-center text-xs sm:text-sm opacity-50 pointer-events-none">
        <p>Built with CraftFolio [developed by Archivo DevSpace]</p>
      </footer>
    </main>
  );
}
